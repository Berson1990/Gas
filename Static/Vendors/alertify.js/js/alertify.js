    ...
    function t() {
        var t= {
            ...
            dialogs: {
                buttons: {
                    ...
                    cancel:"<button class='cancel' tabindex='2'>{{cancel}}</button>",
                     ok:"<button class='ok btn btn-success' tabindex='1'>{{ok}}</button>"
                }
                ,
            ...
            build:function(t) {
                ...
                o="<div dir='rtl' class='dialog'><div>"+this.dialogs.message.replace("{{message}}", t.message);
            ...
            theme:function(t) {
                switch(t.toLowerCase()) {
                    case"bootstrap":this.dialogs.buttons.ok="<button class='ok btn btn-success' tabindex='1'>{{ok}}</button>",
                    this.dialogs.buttons.cancel="<button class='cancel btn btn-default' tabindex='2'>{{cancel}}</button>",
                    this.dialogs.input="<input type='text' class='form-control'>";
                    break;
                    case"purecss":this.dialogs.buttons.ok="<button class='ok pure-button btn btn-success' tabindex='1'>{{ok}}</button>",
                    this.dialogs.buttons.cancel="<button class='cancel pure-button' tabindex='2'>{{cancel}}</button>";
                    break;
                    case"mdl":case"material-design-light":this.dialogs.buttons.ok="<button class='ok btn btn-success mdl-button mdl-js-button mdl-js-ripple-effect'  tabindex='1'>{{ok}}</button>",
                    ...
                    break;
                    case"angular-material":this.dialogs.buttons.ok="<button class='ok btn btn-success md-primary md-button' tabindex='1'>{{ok}}</button>",
